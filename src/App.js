    ...
    <section className="section services" id="services">
      ...
      <div className="section-center services-center">
        ...
        <article className="service">
          ...
          <div className="service-info">
            <h4 className="service-title">Endless Adventure</h4>
            <p className="service-text">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Asperiores, officia.
            </p>
      ...
      <div className="section-center featured-center">
        <article className="tour-card">
          ...
          <div className="tour-info">
            ...
            <div className="tour-footer">
              <p>
                <span><i className="fas fa-map"></i></span> Kumbh North
              </p>
              <p>6 days</p>
              <p>from $2100</p>
            </div>
        ...
        <article className="tour-card">
          ...
          <div className="tour-info">
            ...
            <div className="tour-footer">
              <p>
                <span><i className="fas fa-map"></i></span> kumbh west
              </p>
              <p>11 days</p>
              <p>from $1400</p>
            </div>
        ...
        <article className="tour-card">
          ...
          <div className="tour-info">
            ...
            <div className="tour-footer">
              <p>
                <span><i className="fas fa-map"></i></span> Kumbh East
              </p>
              <p>8 days</p>
              <p>from $5000</p>
            </div>
        ...
        <article className="tour-card">
          ...
          <div className="tour-info">
            ...
            <div className="tour-footer">
              <p>
                <span><i className="fas fa-map"></i></span> Kumbh South
              </p>
              <p>20 days</p>
              <p>from $3300</p>
            </div>
